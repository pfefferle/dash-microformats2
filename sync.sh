...
httrack http://microformats.org/wiki/microformats2 \
  ...
  "-*" "+http://microformats.org/wiki/h-*" "-http://microformats.org/wiki/h-*feedback*" "-http://microformats.org/wiki/h-*issues*" "-http://microformats.org/wiki/h-*brainstorming*" "-http://microformats.org/wiki/h-*draft*" \
